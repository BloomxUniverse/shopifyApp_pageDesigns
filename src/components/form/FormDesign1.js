            ...
            <div className={`grid grid-cols-1 gap-x-[25px] mt-[22px] gap-y-[20px] ${themeSetting.tableimage.enable === false ?  'md:grid-cols-3' : 'md:grid-cols-2' }`}>
              ...
              <div className="mt-[40px] w-full md:w-[60%] mx-auto">
                <button
                    ...
                    className="block w-full  rounded-[40px] min-h-[50px] py-[12px] sm:py-[12px] text-center text-[20px] font-[500] bg-[#00182E] text-white hover:shadow-lg hover:bg-[#F0ECE9] hover:opacity-[.8]"
                >
                    Submit
                </button>
