      ...
      <div className="w-full bg-[#EAFFFC]" id="resultView">
        <div className="w-[90%] sm:w-[80%] mx-auto py-[80px]">
          <div className="">
            ...
            <div className="flex lg:flex-row flex-col gap-[30px] mt-[30px] lg:mt-[40px] ">
              <div
                style={{
                  boxShadow: "rgba(149, 157, 165, 0.2) 0px 8px 24px",
                  color: themeSetting && themeSetting.form.color,
                }}
                className="self-start bg-white border text-[14px] md:text-[16px] overflow-hidden text-[#004563] rounded-[20px] sm:rounded-[40px] w-full order-2 lg:order-1"
              >
              ...
              {themeSetting && themeSetting.resultbox.userinput && (
                <div
                  ...
                  className="bg-white text-[14px] md:text-[16px] overflow-hidden border text-[#004563] rounded-[20px] sm:rounded-[40px] w-full order-1 font-inter"
                >
                  <div className="flex p-[15px] border-b sm:px-[40px]">
                    <div>
